...
public class MemberLogin extends Dialog {
	...
	public MemberLogin(Shell parentShell) {
		super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        parent.getShell().setText("UBCollaboration: Add Developer");   
        //setBackground(Color.blue);
		Composite container = (Composite) super.createDialogArea(parent);
            GridLayout layout = new GridLayout(2, false);
            layout.marginRight = 5;
            layout.marginLeft = 10;
            container.setLayout(layout); //Label User
           
            Label lblUser = new Label(container, SWT.NONE);
            lblUser.setText("Developer UserID");  // Username input
            ...
            lblPassword.setText("Developer Password:");
    ...
    protected void createButtonsForButtonBar(Composite parent) {
            createButton(parent, IDialogConstants.OK_ID, "AddDeveloper", true);
